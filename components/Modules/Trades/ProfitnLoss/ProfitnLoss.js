                ...
                <>
                    <div className="flex flex-row items-center">
                        ...
                        <div className='w-full flex flex-col  relative justify-center h-full'>
                            ...
                            <span className="text-lg font-semibold text-positive opacity-60 flex flex-row items-center gap-2">
                ...
                <>
                    <div className="flex flex-row items-center">
                        ...
                        <div className='w-full flex flex-col  relative justify-center h-full'>
                            ...
                            <span className="text-lg font-semibold text-negative opacity-60 flex flex-row gap-2 items-center">
