...
export default function Header({ fixed }) {
  ...
  return (
    <>
      <nav
        className={`w-full z-10 relative px-4 md:px-8 py-2 md:py-4 mx-auto justify-center ${
          fixed
            ? "sticky top-0 bg-[#1A1921] bg-opacity-80 backdrop-blur-lg"
            : ""
        }`}
      >
          ...
          <div className="">
            <Link href={"/"}>
              <Image
                ...
                width={200}
                height={70}
                className="hidden md:block py-2 pr-4 mr-4 "
              />
              <Image
          ...
          <div className="relative flex flex-row items-center justify-between gap-8 lg:gap-16 overflow-visible">
            <div className="flex flex-row gap-8 items-center ">
              ...
              <Link
                ...
                className="h-6 w-6 self-center relative"
              >
            ...
            <div className="flex flex-row gap-8">
              {xrpAddress ? (
                <div className="flex flex-row gap-2 items-center">
                  <Button
                    onClick={openModal}
                    className="!px-0 text-2xl bg-transparent font-semibold"
                    disableAnimation
                  >
                    <div
                      className="rounded-full h-10 w-10 md:mr-4 bg-default-avatar"
                      title={xrpAddress}
                      style={
                        userData.pfp_nft_url
                          ? {
                              backgroundImage: `url(${userData.pfp_nft_url})`,
