...
function ProfileSettings({ children }) {
    const variants = {
        hidden: { opacity: 0, scale: 0.6, transition: { duration: 0.2, ease: 'easeInOut' } },
                ...
                <div className="w-full flex flex-col gap-16">
                    <div className='relative w-full h-40 md:h-72 rounded-2xl bg-[#21212A] p-2'>
                        <motion.div
                            ...
                            initial="hidden"
                            whileHover="visible"
                            className="w-full h-full rounded-2xl bg-[#1A1921] cursor-pointer bg-opacity-60 backdrop-blur-md flex items-center justify-center"
                        >
